---
title: "DevOps Project-23: DevSecOps - Blue-Green Deployment of Swiggy-Clone on AWS ECS with AWS Code Pipeline"
summary: This project demonstrates a secure CI/CD pipeline using AWS CodePipeline and ECS to deploy a Swiggy-like food delivery application with a blue-green deployment strategy to ensure zero downtime and safer rollouts.
objective: Implement a secure, zero-downtime deployment for containerized applications on AWS ECS using DevSecOps best practices and blue-green deployment via AWS CodePipeline.
tone:
  - technical
  - hands-on
tags:
