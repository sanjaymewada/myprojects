---
title: "DevOps Project-26: Automating AWS Infrastructure Deployment Using Terraform and GitLab CI/CD"
summary: This project demonstrates how to automate the provisioning of cloud infrastructure on AWS using Terraform, integrated with GitLab CI/CD for continuous delivery and infrastructure automation.
objective: Build a fully automated, scalable, and repeatable infrastructure deployment workflow on AWS using Terraform and GitLab CI/CD pipelines.
tone:
  - technical
  - cloud-native
  - hands-on
