---
title: "DevOps Project-29: CI/CD Project - Deploy a 3-Tier Microservice Voting App using ArgoCD and Azure DevOps Pipeline"
summary: This project focuses on deploying a 3-tier microservice-based Voting App leveraging ArgoCD for GitOps-based continuous deployment and Azure DevOps for orchestrating the CI/CD pipelines.
objective: Implement CI/CD workflows for a 3-tier microservice Voting App using Azure DevOps Pipelines for CI and ArgoCD for GitOps-based CD to Kubernetes.
tone:
  - technical
  - modern
  - hands-on
