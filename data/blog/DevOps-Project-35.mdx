---
title: "DevOps Project-35: CI/CD DevOps Pipeline Project: Deployment of Java Application on Kubernetes"
summary: This project focuses on building a robust CI/CD pipeline for deploying a Java-based application on Kubernetes. It demonstrates key DevOps principles including containerization, orchestration, and automation using industry-standard tools.
objective: Automate the deployment of a Java application on Kubernetes using a CI/CD pipeline integrated with best practices for scalability and reliability.
tone:
  - technical
  - hands-on
  - automation-focused
