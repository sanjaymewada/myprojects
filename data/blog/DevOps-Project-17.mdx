---
title: "DevOps Project-17: Deploying an App to AKS using Azure DevOps & Azure Cloud Shell"
summary: This project showcases how to deploy a containerized application to Azure Kubernetes Service (AKS) using Azure DevOps pipelines and Azure Cloud Shell. It highlights best practices in CI/CD automation within the Azure ecosystem.
objective: Deploy a containerized application to AKS using Azure DevOps and Cloud Shell, demonstrating CI/CD automation and cloud-native deployment on Microsoft Azure.
tone:
  - technical
  - cloud-focused
tags:
