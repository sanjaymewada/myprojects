---
title: "DevOps Project-30: CI/CD Project - Production Level Blog App Deployment using EKS, Nexus, SonarQube, Trivy with Monitoring Tools"
summary: This project demonstrates a production-ready CI/CD pipeline for a blog application using Amazon EKS, integrated with Nexus for artifact management, SonarQube for code quality checks, and Trivy for container vulnerability scanning, along with robust monitoring tools.
objective: Build and deploy a secure, production-grade blog application using a full CI/CD pipeline integrated with quality assurance and monitoring tools on EKS.
tone:
  - enterprise-grade
  - secure
  - hands-on
